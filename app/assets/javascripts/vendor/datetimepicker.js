...
!function( $ ) {
	...
	Datetimepicker.prototype = {
        ...
        var dow = dates[this.language].daysMin[(dowCnt++)%7];
        var mincls = '';
        if (dow === 'Sa' || dow === 'Su') {
          mincls = ' weekend';
        }
				html += '<th class="dow'+mincls+'">'+dow+'</th>';
			}
			html += '</tr>';
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev"><span class="glyphicon glyphicon-arrow-left no-events"/></th>'+
								'<th colspan="5" class="switch"></th>'+
								'<th class="next"><span class="glyphicon glyphicon-arrow-right no-events"/></th>'+
							'</tr>'+
						'</thead>',
